...
<html lang="en">
    ...
    <div class="navbar navbar-light" style="background-color: #e3f2fd;">
                ...
                <form action="index.php?action=criavancer" method="POST">
                    <label for="espece"> espece : </label>
                    <select class="selecForm2" name="espece" id="">
                    ...
                    <select class="selecForm2"name="sexe" id="">
                            <option value="M">MASCULIN</option>
                            <option value="F">FEMININ</option>
                    </select>
                    <label for="operateur">operateur</label>
                    <select class="selecForm2"name="operateur" id="">
                            <option value="inf">avant</option>
                            <option value="sup">apres</option>
                            <option value="egal">en</option>
                    </select>
                    <label for="date">date</label>
                    <input class="selecForm2" type="date" name="date">
